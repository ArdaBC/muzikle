 ...
 */
package com.ardaltug.common.avro;
...
public class UserAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6342055115221628032L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserAvro\",\"namespace\":\"com.ardaltug.common.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"password\",\"type\":\"string\"}]}");
   ...
   */
  public UserAvro(java.lang.CharSequence id, java.lang.CharSequence name, java.lang.CharSequence password) {
    this.id = id;
    this.name = name;
   ...
   */
  public static com.ardaltug.common.avro.UserAvro.Builder newBuilder() {
    return new com.ardaltug.common.avro.UserAvro.Builder();
  }
   ...
   * @return A new UserAvro RecordBuilder
   */
  public static com.ardaltug.common.avro.UserAvro.Builder newBuilder(com.ardaltug.common.avro.UserAvro.Builder other) {
    if (other == null) {
      return new com.ardaltug.common.avro.UserAvro.Builder();
    } else {
      return new com.ardaltug.common.avro.UserAvro.Builder(other);
    }
  }
   ...
   * @return A new UserAvro RecordBuilder
   */
  public static com.ardaltug.common.avro.UserAvro.Builder newBuilder(com.ardaltug.common.avro.UserAvro other) {
    if (other == null) {
      return new com.ardaltug.common.avro.UserAvro.Builder();
    } else {
      return new com.ardaltug.common.avro.UserAvro.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserAvro>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ardaltug.common.avro.UserAvro.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ardaltug.common.avro.UserAvro other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ardaltug.common.avro.UserAvro.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ardaltug.common.avro.UserAvro.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ardaltug.common.avro.UserAvro.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ardaltug.common.avro.UserAvro.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ardaltug.common.avro.UserAvro.Builder setPassword(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ardaltug.common.avro.UserAvro.Builder clearPassword() {
      password = null;
